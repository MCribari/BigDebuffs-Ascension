...
if WOW_PROJECT_ID ~= WOW_PROJECT_CLASSIC then
    for i = 1, #BigDebuffs.WarningDebuffs do
        ...
        WarningDebuffs[name] = {
            ...
            name = name,
            desc = function()
                local spellDesc = GetSpellDescription(id) or ""
                local extra =
